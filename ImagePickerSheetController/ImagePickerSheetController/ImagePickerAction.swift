...
@objc open class ImagePickerAction:NSObject {
...
//    }
    ...
    /// Secondary handler defaults to handler if not specified
    @objc public init(title: String, secondaryTitle: Title?, style: ImagePickerActionStyle = .default, handler: @escaping Handler, secondaryHandler secondaryHandlerOrNil: SecondaryHandler? = nil) {
